...
export default function index() {
    return (
        <div className="w-100 d-flex justify-content-between align-items-center " style={{padding: "1.5% 15%",background:"white"}}>
            <div className="m-0 logo">
                <h4 className="font-weight-bold m-0">Saurabh Burade</h4>
            </div>
            <nav className="nav-menu d-flex align-items-center" style={{listStyleType:"none"}}>
